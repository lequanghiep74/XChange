...
public class BinanceTradeServiceRaw extends BinanceBaseService {
  ...
  public BasePageResponse<Loan> allLoans(CurrencyPair assets, Integer size, long timestamp)
      throws BinanceException, IOException {
    return binance.allLoans(
        BinanceAdapters.toSymbol(assets), size, timestamp, super.apiKey, super.signatureCreator);
  }
}
